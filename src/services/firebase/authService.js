...
export const getUsers = async () => {
    const allSectors = ['enfermagem', 'medica', 'qualidade', 'faturamento', 'psicologia', 'nutricao', 'rh', 'recepcao', 'estoque', 'compras'];
    const defaultUsers = [
      { uid: 'techcosta-admin-uid', email: 'contato@techcosta.net', name: 'TechCosta', role: 'admin', allowedSectors: allSectors, allowedUnits: ['all', 'betim', 'taguatinga'], primaryUnit: 'betim', status: 'active', crm: '45892/MG', specialty: 'Nefrologia' },
      { uid: 'doc-lucas-uid', email: 'lucas.mendes@nexa.com', name: 'Lucas Mendes', role: 'doctor', allowedSectors: ['medica'], primaryUnit: 'betim', allowedUnits: ['betim'], status: 'active', crm: '45892/MG', specialty: 'Nefrologia', contractType: 'PJ', pixKey: '45892000182@pix.bcb.gov.br', bank: 'Banco do Brasil (001) Ag 1234-5 CC 45892-1' },
      { uid: 'doc-mariana-uid', email: 'mariana.ribeiro@nexa.com', name: 'Mariana Ribeiro', role: 'doctor', allowedSectors: ['medica'], primaryUnit: 'betim', allowedUnits: ['betim'], status: 'active', crm: '51204/MG', specialty: 'Nefrologia', contractType: 'PJ', pixKey: 'mariana.med@gmail.com', bank: 'Itaú (341) Ag 0891 CC 32104-9' },
      { uid: 'doc-roberto-uid', email: 'roberto.carvalho@nexa.com', name: 'Roberto Carvalho', role: 'doctor', allowedSectors: ['medica'], primaryUnit: 'betim', allowedUnits: ['betim'], status: 'active', crm: '39812/MG', specialty: 'Nefrologia', contractType: 'PJ', pixKey: '39812984000192', bank: 'Santander (033) Ag 2201 CC 98120-4' },
      { uid: 'doc-camila-uid', email: 'camila.albuquerque@nexa.com', name: 'Camila Albuquerque', role: 'doctor', allowedSectors: ['medica'], primaryUnit: 'betim', allowedUnits: ['betim'], status: 'active', crm: '48920/MG', specialty: 'Nefrologia', contractType: 'CLT', pixKey: 'camila.albuquerque@pix.com', bank: 'Bradesco (237) Ag 1402 CC 89201-3' },
      { uid: 'doc-fernando-uid', email: 'fernando.vasconcelos@nexa.com', name: 'Fernando Vasconcelos', role: 'doctor', allowedSectors: ['medica'], primaryUnit: 'betim', allowedUnits: ['betim'], status: 'active', crm: '55431/MG', specialty: 'Nefrologia', contractType: 'PJ', pixKey: '5543189000109', bank: 'Sicoob (756) Ag 4120 CC 55431-0' },
      ...
      { uid: 'taguatinga-fin-uid', email: 'financeiro.taguatinga@nexa.com', name: 'Operadora Financeira', role: 'financial', allowedSectors: ['faturamento', 'finance', 'estoque', 'compras'], allowedUnits: ['taguatinga'], primaryUnit: 'taguatinga', status: 'active' },
